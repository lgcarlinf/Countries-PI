...
import { getCountries,filterCountryByRegion,orderByName, orderByPoblation,getActivities,filterByActivity} from "../../actions";
    ...
    <div className="init">
      ...
      <div className="filterSearch">
        ...
        <div className="filterName">
          ...
          <option className='option' value='0'>Alphabetic</option> 
            <option className='option' value="asc">order by A-Z</option>
            <option className='option' value="desc">order by Z-A</option>
          </select>
        </div>
        <div className="filterPoblacion" >
          <p>Poblacion:</p>
          <select className="select" onChange={e=> handleFilterPoblation(e)}>
          <option className='option' value='0'>Select Poblation</option> 
        ...
        <Link className='create' to="/countries/activity">Create Activity</Link>
      </div>
